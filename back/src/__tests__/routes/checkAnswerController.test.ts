...
describe('POST /api/check-answer', () => {
  ...
  it('when submitting expectedAnswers array with matching answer, then returns correct true', async () => {
    // Given
    const payload = {
      userAnswer: 'じゅう',
      expectedAnswers: ['じゅう', 'とお'],
    };
  ...
  it('when submitting expectedAnswers array with no matching answer, then returns correct false', async () => {
    // Given
    const payload = {
      userAnswer: 'ちがう',
      expectedAnswers: ['じゅう', 'とお'],
